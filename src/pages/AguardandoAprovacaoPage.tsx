  ...
  return (
    <div className="min-h-[100dvh] flex flex-col items-center justify-center bg-background p-6 text-center">
      ...
      <div className="flex flex-col sm:flex-row gap-3 w-full max-w-xs">
        <Button asChild className="bg-emerald-600 hover:bg-emerald-700 min-h-[48px] flex-1">
          <a href={whatsappUrl} target="_blank" rel="noopener noreferrer">
            <MessageCircle className="h-4 w-4 mr-2" />
            Falar com Suporte
          </a>
        </Button>
        <Button variant="outline" onClick={() => logout()} className="min-h-[48px] flex-1">Voltar ao Login</Button>
      </div>
    </div>
  );
}
